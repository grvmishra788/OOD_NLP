...
class Newsgroup20:
    ...
    def __init__(self):
        self.train_file = './Baseline/Categorization/data/20ng-train.txt'
        self.test_file = './Baseline/Categorization/data/20ng-test.txt'
        self.max_example_len = 1000
        self.batch_size = 32
        self.embedding_dims = 30
    ...
    def train_model(self):
        ...
        if constants.RE_TRAIN:
            ...
            # restore variables from disk
            saver.restore(sess, os.path.join(constants.MODELS_FOLDER,"best_newsgroup_model.ckpt"))
